 ...
 * @param $params->fields {stringCommaSeparated} — The name(s) of the document fields (or TVs) for which the widget is applying. @required
 ...
 * 
 * @link http://code.divandesign.biz/modx/mm_ddreadonly
 * 
